...
public class BangCongKhoiSanXuat implements Serializable{
    ...
    public BangCongKhoiSanXuat(String maNhanVien, String hoTen, String ngaySinh, String luongCoBan, String phuCap, String phuCapKhac, String thang, String nam, String soNgayCong, String soNgayNghi, String soGioLam) {
        this.maNhanVien = maNhanVien;
        this.hoTen = hoTen;
